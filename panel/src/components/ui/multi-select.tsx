...
>(({ className, ...props }, forwardedRef) => {
    ...
    return (
        <div
            ref={forwardedRef}
    className={cn('py-6 text-center ~text-xs/sm', className)}
    cmdk-empty=""
    role="presentation"
    {...props}
    />
    ...
    (
        ...
        return (
            <Command
                ...
                <div
                    className={cn(
                    'min-h-10 rounded-md border border-zinc-800 ~text-xs/sm ring-offset-background focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2',
                        {
                ...
                <div className="relative">
                    {open && (
                        <CommandList
                            ref={dropdownRef}
                            className="absolute z-50 w-full rounded-md border border-zinc-800 bg-zinc-950 text-popover-foreground shadow-md outline-none animate-in"
                            style={{
                                position: 'fixed',
