...
goog.exportSymbol('proto.protofiles.StaffId', null, global);
 ...
 * @constructor
 */
proto.protofiles.StaffId = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.protofiles.StaffId, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.protofiles.StaffId.displayName = 'proto.protofiles.StaffId';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.protofiles.StaffObject.repeatedFields_ = [4];
...
proto.protofiles.StaffObject.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    permsList: (f = jspb.Message.getRepeatedField(msg, 4)) == null ? undefined : f,
 ...
 * @return {!Object}
 */
proto.protofiles.StaffId.prototype.toObject = function(opt_includeInstance) {
  return proto.protofiles.StaffId.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.protofiles.StaffId} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.protofiles.StaffId.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.protofiles.StaffId}
 */
proto.protofiles.StaffId.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.protofiles.StaffId;
  return proto.protofiles.StaffId.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.protofiles.StaffId} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.protofiles.StaffId}
 */
proto.protofiles.StaffId.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.protofiles.StaffId.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.protofiles.StaffId.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.protofiles.StaffId} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.protofiles.StaffId.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.protofiles.StaffId.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.protofiles.StaffId} returns this
 */
proto.protofiles.StaffId.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
