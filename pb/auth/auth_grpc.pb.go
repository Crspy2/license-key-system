...
const (
	...
	Auth_GetUserSessionsStream_FullMethodName = "/auth.Auth/GetUserSessionsStream"
...
func (c *authClient) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*StandardResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *authClient) GetUserSessionsStream(ctx context.Context, in *MultiSessionRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[SessionObject], error) {
	...
	x := &grpc.GenericClientStream[MultiSessionRequest, SessionObject]{ClientStream: stream}
...
func _Auth_RevokeSession_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).RevokeSession(ctx, req.(*SessionRevokeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
